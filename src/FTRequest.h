...
@property(nonatomic,assign) id<FTRequestDelegate> delegate;
 ...
 */
- (void)requestLoading:(FTRequest *)request;

/**
 * Called when the server responds and begins to send back data.
 */
- (void)request:(FTRequest *)request didReceiveResponse:(NSURLResponse *)response;
 ...
 */
- (void)request:(FTRequest *)request didLoadRawResponse:(NSData *)data;
