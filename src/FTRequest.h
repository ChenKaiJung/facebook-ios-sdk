 ...
 */
- (void)ftRequestLoading:(FTRequest *)request;
 ...
 */
- (void)ftRequest:(FTRequest *)request didFailWithError:(NSError *)error;
 ...
 */
- (void)ftRequest:(FTRequest *)request didLoadRawResponse:(NSData *)data;
