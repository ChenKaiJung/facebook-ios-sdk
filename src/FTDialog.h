...
@interface FTDialog : UIView <UIWebViewDelegate> {
    id<FTDialogDelegate> _delegate;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<FTDialogDelegate> delegate;
 ...
 */
@protocol FTDialogDelegate <NSObject>
