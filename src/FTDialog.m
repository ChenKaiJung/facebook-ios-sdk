...
static NSString* kDefaultTitle = @"Connect to Funtown";

static CGFloat kFuntownRed[4] = {0.82352941, 0, 0.16078431, 1.0};
static CGFloat kBorderGray[4] = {0.7, 0.7, 0.7, 0.6};
static CGFloat kBorderBlack[4] = {0.3, 0.3, 0.3, 1};
static CGFloat kBorderRed[4] = {1.0, 0, 0, 1.0};
...
- (id)init {
    if (self = [super initWithFrame:CGRectZero]) {
        ...
        UIImage* iconImage = [UIImage imageNamed:@"FTDialog.bundle/images/fticon.png"];
        UIImage* closeImage = [UIImage imageNamed:@"FTDialog.bundle/images/close.png"];
        ...
        CGFloat titleLabelFontSize = (FTIsDeviceIPad() ? 18 : 14);
...
- (void)drawRect:(CGRect)rect {
    ...
    [self drawRect:headerRect fill:kFuntownRed radius:0];
    [self strokeLines:headerRect stroke:kBorderRed];
...
- (id)initWithURL: (NSString *) serverURL
         ...
         delegate: (id <FTDialogDelegate>) delegate {
